...
CodeMirrorUI.prototype = {
  ...
  load: function() {
      ...
      if (window.File && window.FileReader && window.FileList && window.Blob) {
        ...
        file_button.click();
        //button.change(alert('selected'));
        //$("#file").change(alert("file changed"));
        //alert("test");
  ...
  initialize: function(textarea, options, mirrorOptions) {
    ...
    this.buttonDefs = {
      'save': ["Save", "save", this.options.imagePath + "/new_save.png", this.save],
      'search': ["Search/Replace", "find_replace_popup", this.options.imagePath + "/new_find.png", this.find_replace_popup],
      'searchClose': ["Close", "find_replace_popup_close", this.options.imagePath + "/cancel.png", this.find_replace_popup_close],
      'searchDialog': ["Search/Replace", "find_replace_window", this.options.imagePath + "/new_find.png", this.find_replace_window],
      'undo': ["Undo", "undo", this.options.imagePath + "/new_undo.png", this.undo],
      'redo': ["Redo", "redo", this.options.imagePath + "/new_redo.png", this.redo],
      'jump': ["Jump to line #", "jump", this.options.imagePath + "/new_jump.png", this.jump],
      'reindentSelection': ["Reformat selection", "reindentSelect", this.options.imagePath + "/new_format_selection.png", this.reindentSelection],
      'reindent': ["Reformat whole document", "reindent", this.options.imagePath + "/new_format.png", this.reindent],
      'about': ["About CodeMirror-UI", "about", this.options.imagePath + "/new_about.png", this.about],
      'load' : ["Load File", "load", this.options.imagePath + "/new_load.png", this.load]
    };
